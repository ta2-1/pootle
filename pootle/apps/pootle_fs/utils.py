...
class StoreFSPathFilter(PathFilter):
    """Filters StoreFS
...
class StorePathFilter(PathFilter):
    ...
    @property
    def fs_regex(self):
        """prevents the class from ever filtering on fs path"""
        return None
