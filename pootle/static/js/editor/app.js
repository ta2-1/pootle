...
PTL.editor = {
    ...
    setTimeout(function () {
      $.history.init(function (hash) {
        ...
        if ('filter' in params) {
          ...
          if (filterName === 'checks' && 'categories' in params) {
            PTL.editor.categories = params.categories.split(',');
          }
          if ('sort' in params) {
  ...
  getReqData: function () {
    ...
    if (this.filter === 'checks' && this.categories.length) {
      reqData.categories = this.categories.join(",");
    }
